...
const CompletedRequests = () => {
  ...
  const getCompletedRequests = async () => {
    let results = await axios.get(API_REQUESTS + "?completed=true");
  ...
  const uncompleteRequest = async (request) => {
    console.log(request.completed);
    await axios.post(API_REQUESTS + request.id + "?status=false");
                  ...
                  <form>
                    <Flex align={"center"} justify={"center"}>
                      <Checkbox
                        ...
                        onChange={() => uncompleteRequest(result)}
                      ></Checkbox>
                    </Flex>
                  </form>
                </Td>
